...
them, even if it finishes last — the obligation passes up to the next team that is not
shielded. **If several teams tie at the bottom**, once the shielded ones are set aside,
...
- **A team with no row for the round** is absent from the calculation, not counted as zero:
  ...
  finishing last.
- **If every team were shielded**, nobody brings breakfast and the line says exactly that.
  It cannot happen with thirteen teams and a three-round shield — at most six are ever
  covered — but a rule that silently picks somebody would be worse than one that says
  nobody.
...
- Nobody: **"Round 5: nobody brings breakfast — everyone at the bottom is shielded."**
